...
public class FollowerConstants {
    ...
    private static double xMovement = 45.99874409529281;
    private static double yMovement = 50.36743560626564;
    ...
    public static double mass = 14.65942;
    ...
    public static double forwardZeroPowerAcceleration = -56.906277686617656;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -50.43404940909838;
