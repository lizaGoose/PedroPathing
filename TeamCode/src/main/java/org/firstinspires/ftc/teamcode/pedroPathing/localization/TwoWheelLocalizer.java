...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double WHEEL_RADIUS = 19/25.4;
    public static double xMultiplier = 1.0055485897862717 ;
    public static double yMultiplier = 1.0141748058329016 ;
   /* public static double FORWARD_TICKS_TO_INCHES = 8192 * 1.0055485897862717  * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = 8192 * 1.0141748058329016  * 2 * Math.PI * 0.5018874659;*/
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(1.73006/2.54, 6.77719/2.54, 0);
        strafeEncoderPose = new Pose(-0.92520/2.54, 6.56961/2.54, Math.toRadians(90));
        ...
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "MotorLR"));
    ...
    public Matrix getRobotDeltas() {
        ...
        // x/forward movement
        returnMatrix.set(0,0, encoderTicksToInches(forwardEncoder.getDeltaPosition()));
        //y/strafe movement
        returnMatrix.set(1,0, encoderTicksToInches(strafeEncoder.getDeltaPosition()));
        // theta/turning
